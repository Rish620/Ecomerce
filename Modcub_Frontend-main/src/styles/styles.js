const styles = {
    ...
    heading:
        "text-[27px] text-center md:text-start font-[600] font-Roboto pb-[20px] text-amber-600",
    ...
    price: "font-[500] text-[16px] text-[#d55b45] mt-[-4px] line-through",
    ...
    cart_button_text: "text-[#fff] text-[16px] font-[600] max-450px:text-[12px]",
