...
import { editProduct, getShopProductById } from "../../redux/actions/product";
import { categoriesData } from "../../static/data";
import { toast } from "react-toastify";

const EditProduct = () => {
    const { seller } = useSelector((state) => state.seller);
    const {success, error, productById,isLoading } = useSelector((state) => state.products);
    ...
    useEffect(() => {
            dispatch(getShopProductById(id));    
                   }, [id, dispatch]);
